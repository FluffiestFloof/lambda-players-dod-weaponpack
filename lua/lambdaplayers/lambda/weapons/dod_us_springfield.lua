...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    ...
    dod_springfield = {
        ...
        callback = function( self, wepent, target )
            ...
            wepent:EmitSound( "lambdaplayers/weapons/dayofdefeat/spring_shoot.mp3", 80, 100, 1, CHAN_WEAPON )
            ...
            self:SimpleTimer( 0.2, function()
                wepent:EmitSound( "lambdaplayers/weapons/dayofdefeat/k98_boltpull.mp3", 75, 100, 1, CHAN_WEAPON )
